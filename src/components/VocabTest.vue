<template>
    <div>
      ...
      <form action="#" @submit.prevent="onSubmit">
        ...
        <div class="ui labeled input fluid">
          ...
          <input type="text" placeholder="Escribe aquí..." v-model="spanish" :disabled="testOver" autocomplete="off" />
        </div>
  ...
  export default {
    ...
    methods: {
      onSubmit: function() {
        if (this.english === this.currWord.english && this.spanish === this.currWord.spanish) {
